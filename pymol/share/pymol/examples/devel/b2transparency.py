'''
This is a modification of: http://pymolwiki.org/index.php/B2transparency

Uses the new settings write support in alter.
'''
...
SEE ALSO
    ...
    cmd.alter(selection, "settings['%s'] = min(max((%s - %f) / %f, 0), 0.9)" %
